...
type service struct {
	...
	DeviceCGroupsRules []string                      `yaml:"device_cgroup_rules"`
...
func loadVolumes(app *app.ArduinoApp, cfg config.Configuration, devices peripherals.AvailableDevices, platform platform.Platform) []volume {
	volumes := []volume{
		{
			Type:   "bind",
